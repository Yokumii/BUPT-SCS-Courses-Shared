...
if __name__ == '__main__':
    ...
    # 换一组基来计算，对应于和之前不同的问题。注意构造线性变换y=Tx的时候，保障y也属于该线性空间
    ...
    for n in range(N):
        a = element(ls, 'coordinate', [1+n*0.01,2+n*0.01,3-n*0.01])
        b = function(mapping)(a.value())
    end1 = time.process_time()
    cpu_time1 = end1 - start
    print('直接计算f(T)(x) ',N,'次的计算时间：',cpu_time1)
    ...
    cpu_time2 = end2 - end1
    print('利用矩阵论框架计算f(T)(x) ',N,'次的计算时间：',cpu_time2)
